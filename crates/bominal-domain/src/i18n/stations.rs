...
pub const SRT_STATIONS: &[StationEntry] = &[
    ...
    StationEntry {
        korean: "평택지제",
        english: "Pyeongtaek-Jije",
        japanese: "ピョンテクチジェ",
    },
    StationEntry {
        korean: "천안아산",
        english: "Cheonan-Asan",
        japanese: "チョナンアサン",
    },
    StationEntry {
        korean: "오송",
    ...
    StationEntry {
        korean: "신경주",
        english: "Sin-Gyeongju",
        japanese: "シンギョンジュ",
    },
    StationEntry {
        korean: "울산(통도사)",
        english: "Ulsan (Tongdosa)",
        japanese: "ウルサン（トンドサ）",
    },
    StationEntry {
        korean: "부산",
    ...
    StationEntry {
        korean: "창원중앙",
        english: "Changwon-Jungang",
        japanese: "チャンウォンチュンアン",
    },
    StationEntry {
        korean: "경산",
        english: "Gyeongsan",
...
mod tests {
    ...
    fn station_name_divergence() {
        ...
        assert_eq!(
            display_name(Locale::En, "김천(구미)", "SRT"),
            "Gimcheon-Gumi"
        );
