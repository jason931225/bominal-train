...
impl AppConfig {
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            ev_team_id: std::env::var("EV_TEAM_ID")
                .context("EV_TEAM_ID is required")?,
            ev_app_id: std::env::var("EV_APP_ID")
                .context("EV_APP_ID is required")?,
            ev_api_key: std::env::var("EV_API_KEY")
                .context("EV_API_KEY is required")?,
            ev_srt_domain: std::env::var("EV_SRT_DOMAIN")
                .context("EV_SRT_DOMAIN is required")?,
            ev_ktx_domain: std::env::var("EV_KTX_DOMAIN")
                .context("EV_KTX_DOMAIN is required")?,
            environment,
        })
    }
