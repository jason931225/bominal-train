...
class TaskSummaryOut(BaseModel):
    ...
    last_attempt_action: str | None = None
    last_attempt_ok: bool | None = None
    last_attempt_error_code: str | None = None
    last_attempt_error_message_safe: str | None = None
    last_attempt_finished_at: datetime | None = None
    retry_now_allowed: bool = False
    retry_now_reason: str | None = None
    retry_now_available_at: datetime | None = None
    spec_json: dict
