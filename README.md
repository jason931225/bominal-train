...
2) Review generated files and confirm required values:
   ...
   - `infra/env/prod/api.env` payment contract when enabled: `PAYMENT_PROVIDER=evervault`, `PAYMENT_EVERVAULT_ENFORCE=true`, `AUTOPAY_REQUIRE_USER_WALLET=true`, `AUTOPAY_ALLOW_SERVER_FALLBACK=false`
