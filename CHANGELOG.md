...
- [62b6295] Froze OpenTable OTP response handling contracts in adapter/tests (challenge-ref required on `auth.start`; body-level error handling on `auth.complete`) and updated provider/architecture/plan docs to mark OTP response schema capture complete (`api/app/modules/restaurant/providers/opentable_adapter.py`, `api/tests/test_restaurant_provider_opentable.py`, `docs/provider-research/opentable-endpoints.md`, `docs/provider-research/restaurant-provider-endpoint-inventory.md`, `docs/provider-research/restaurant-provider-canonical-contract.md`, `docs/plans/active/2026-02-17-restaurant-provider-foundations.md`, `docs/ARCHITECTURE.md`).
- [88ebc3c] Implemented Resy stage-1 password auth adapter contract (`POST /4/auth/password`) with config/factory wiring and coverage tests, and updated provider/architecture/plan docs to reflect concrete Resy auth support (`api/app/modules/restaurant/providers/resy_adapter.py`, `api/app/core/config.py`, `api/app/modules/restaurant/providers/factory.py`, `api/tests/test_restaurant_provider_resy.py`, `api/tests/test_restaurant_provider_contracts.py`, `api/tests/test_restaurant_policy_config.py`, `docs/provider-research/resy-endpoints.md`, `docs/provider-research/restaurant-provider-endpoint-inventory.md`, `docs/plans/active/2026-02-17-restaurant-provider-foundations.md`, `docs/ARCHITECTURE.md`, `infra/env/prod/api.env.example`).
- [b014208] Cross-checked `third_party/resy` reference contracts and synchronized Resy endpoint/plan docs for pending availability/create/cancel/profile freeze work (`docs/provider-research/resy-endpoints.md`, `docs/provider-research/restaurant-provider-endpoint-inventory.md`, `docs/plans/active/2026-02-17-restaurant-provider-foundations.md`).
- [33a72c7] Implemented Resy stage-2 adapter execution paths (`profile.get`, `search.availability`, `reservation.create`, `reservation.cancel`) with config-driven endpoints, cancel fallback retry, and RED->GREEN coverage updates (`api/app/modules/restaurant/providers/resy_adapter.py`, `api/app/core/config.py`, `api/app/modules/restaurant/providers/factory.py`, `api/tests/test_restaurant_provider_resy.py`, `api/tests/test_restaurant_provider_contracts.py`, `api/tests/test_restaurant_policy_config.py`, `docs/provider-research/resy-endpoints.md`, `docs/provider-research/restaurant-provider-endpoint-inventory.md`, `docs/plans/active/2026-02-17-restaurant-provider-foundations.md`, `docs/ARCHITECTURE.md`, `infra/env/prod/api.env.example`).
- [3ec91b6] Implemented Resy stage-3 auth/session contract paths with `auth.refresh` (`POST /3/auth/refresh`) and provider-specific logout helper (`POST /3/auth/logout`), including config/factory/env wiring and RED->GREEN adapter coverage (`api/app/modules/restaurant/providers/resy_adapter.py`, `api/app/core/config.py`, `api/app/modules/restaurant/providers/factory.py`, `api/tests/test_restaurant_provider_resy.py`, `api/tests/test_restaurant_provider_contracts.py`, `api/tests/test_restaurant_policy_config.py`, `docs/provider-research/resy-endpoints.md`, `docs/provider-research/restaurant-provider-endpoint-inventory.md`, `docs/plans/active/2026-02-17-restaurant-provider-foundations.md`, `docs/ARCHITECTURE.md`, `infra/env/prod/api.env.example`).
