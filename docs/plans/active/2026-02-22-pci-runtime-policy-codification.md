...
**Architecture:** This is a docs-first governance hardening pass. The policy baseline is centralized in `docs/SECURITY.md` and then cross-enforced by `docs/GUARDRAILS.md`, `docs/PERMISSIONS.md`, and `docs/ARCHITECTURE.md` to remove ambiguity and define deterministic PASS/FAIL gate criteria.
...
**Verification:**
- Run: `rg -n "Cardholder Data Environment|PCI Relay Worker Isolation Policy|MUST NOT|CRITICAL|BLOCK" docs/SECURITY.md`
...
**Verification:**
- Run: `rg -n "Safe Metadata Contract|Redis CVV Storage and Persistence Contract|Logging Enforcement Architecture|Provider Egress Allowlist|SSRF" docs/SECURITY.md`
...
4. Ensure language is consistent with `docs/SECURITY.md`.

**Verification:**
- Run: `rg -n "PCI|CDE|egress|raw provider payload|CVV|card" docs/GUARDRAILS.md docs/PERMISSIONS.md docs/ARCHITECTURE.md`
