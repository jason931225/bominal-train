...
| legacy/node-web/mobile-web supplemental | Popup and JS-asset endpoints (`selectTrainScheduleList.do`, `selectTrainChargeList.do`, `stationInfo.js`, common JS). | High-signal for non-canonical stateless/context-gated data extraction. |
