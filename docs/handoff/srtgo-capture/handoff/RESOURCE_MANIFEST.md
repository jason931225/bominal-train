...
| RES-300 | `docs/handoff/srtgo-capture/HANDOFF_EXTERNAL_REWRITE.md` | handoff_doc | srt/ktx | canonical | required | low | Decision-complete external rewrite handoff |
| RES-001 | `docs/handoff/srtgo-capture/PROVIDER_CONTRACT.md` | contract_doc | srt | canonical | required | low | Canonical contract decisions and divergence notes |
| RES-002 | `docs/handoff/srtgo-capture/PROVIDER_FIELD_MAP.json` | field_map_json | srt/ktx | canonical | required | low | Machine-readable endpoint/field/auth map |
| RES-003 | `docs/handoff/srtgo-capture/PROVIDER_FIELD_MAP.md` | field_map_doc | srt/ktx | canonical | required | low | Human-readable endpoint/field/auth map |
| RES-014 | `docs/handoff/srtgo-capture/generate_provider_field_map.py` | tooling | srt/ktx | supporting | required | low | Field map generator from captures/code/curl evidence |
| RES-301 | `docs/handoff/srtgo-capture/handoff/RESOURCE_MANIFEST.json` | handoff_manifest | srt/ktx | canonical | required | low | Machine-readable handoff inventory |
| RES-302 | `docs/handoff/srtgo-capture/handoff/RESOURCE_MANIFEST.md` | handoff_doc | srt/ktx | canonical | required | low | Human-readable handoff inventory |
| RES-303 | `docs/handoff/srtgo-capture/handoff/STATLESS_ENDPOINT_SHORTLIST.md` | handoff_doc | srt | canonical | required | low | Stateless/context-gated endpoint shortlist |
| RES-304 | `docs/handoff/srtgo-capture/handoff/UNRESOLVED_ENDPOINTS.md` | handoff_doc | srt/ktx | canonical | required | low | Unresolved endpoint semantics and priorities |
...
| RES-013 | `docs/handoff/srtgo-capture/probe_auth_scope.py` | tooling | srt | supporting | required | low | Auth-scope response classifier/prober |
| RES-016 | `docs/handoff/srtgo-capture/pyproject.toml` | env | srt | supporting | optional | low | Capture workspace dependencies |
| RES-010 | `docs/handoff/srtgo-capture/run_cli.py` | tooling | srt | supporting | required | low | Instrumented CLI launcher |
| RES-015 | `docs/handoff/srtgo-capture/tests` | tests | srt | supporting | optional | low | Capture/redaction smoke/unit tests |
| RES-011 | `docs/handoff/srtgo-capture/vendor/srtgo_capture/capture_runtime.py` | tooling | srt | supporting | required | medium | HTTP capture hooks + redaction for CLI flows |
| RES-012 | `docs/handoff/srtgo-capture/web_capture_runtime.py` | tooling | srt_web | supporting | optional | low | Playwright web capture runtime |
