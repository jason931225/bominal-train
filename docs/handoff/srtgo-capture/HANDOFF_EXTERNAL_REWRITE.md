...
- Base artifacts: `docs/handoff/srtgo-capture/PROVIDER_CONTRACT.md`, `docs/handoff/srtgo-capture/PROVIDER_FIELD_MAP.json`, `docs/handoff/srtgo-capture/PROVIDER_FIELD_MAP.md`.
...
- See `docs/handoff/srtgo-capture/handoff/UNRESOLVED_ENDPOINTS.md` for prioritized backlog.

## Evidence Map

- Contracts: `docs/handoff/srtgo-capture/PROVIDER_CONTRACT.md`
- Per-endpoint fields and labels: `docs/handoff/srtgo-capture/PROVIDER_FIELD_MAP.json` and `.md`
