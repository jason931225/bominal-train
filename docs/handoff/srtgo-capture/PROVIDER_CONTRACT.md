...
- Primary entrypoint: `docs/handoff/srtgo-capture/HANDOFF_EXTERNAL_REWRITE.md`
- Machine-readable inventory: `docs/handoff/srtgo-capture/handoff/RESOURCE_MANIFEST.json`
