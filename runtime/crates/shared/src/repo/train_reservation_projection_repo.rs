...
pub struct TrainReservationProjectionRecord {
    pub id: i64,
    pub provider: String,
...
pub trait TrainReservationProjectionRepoContract {
    fn upsert_train_reservation_projection_query<'q>(
        params: &'q UpsertTrainReservationProjectionParams<'q>,
    ) -> Query<'q, Postgres, PgArguments>;

    fn select_train_reservation_projection_query<'q>(
        provider: &'q str,
        reservation_id: &'q str,
    ) -> Query<'q, Postgres, PgArguments>;

    fn select_train_reservation_projections_by_user_query<'q>(
        user_ref: &'q str,
        limit: i64,
    ) -> Query<'q, Postgres, PgArguments>;
}
...
pub struct SqlTrainReservationProjectionRepoContract;

impl TrainReservationProjectionRepoContract for SqlTrainReservationProjectionRepoContract {
    fn upsert_train_reservation_projection_query<'q>(
        params: &'q UpsertTrainReservationProjectionParams<'q>,
    ) -> Query<'q, Postgres, PgArguments> {
        sqlx::query(TRAIN_RESERVATION_PROJECTION_UPSERT_SQL)
    ...
    fn select_train_reservation_projection_query<'q>(
        ...
        sqlx::query(TRAIN_RESERVATION_PROJECTION_SELECT_ONE_SQL)
            .bind(provider)
            .bind(reservation_id)
    }
    ...
    fn select_train_reservation_projections_by_user_query<'q>(
        ...
        sqlx::query(TRAIN_RESERVATION_PROJECTION_SELECT_BY_USER_SQL)
            .bind(user_ref)
            .bind(limit)
    }
}

pub fn upsert_train_reservation_projection_query<'q>(
    params: &'q UpsertTrainReservationProjectionParams<'q>,
) -> Query<'q, Postgres, PgArguments> {
    <SqlTrainReservationProjectionRepoContract as TrainReservationProjectionRepoContract>::upsert_train_reservation_projection_query(params)
}

pub fn select_train_reservation_projection_query<'q>(
    provider: &'q str,
    reservation_id: &'q str,
) -> Query<'q, Postgres, PgArguments> {
    <SqlTrainReservationProjectionRepoContract as TrainReservationProjectionRepoContract>::select_train_reservation_projection_query(provider, reservation_id)
}

pub fn select_train_reservation_projections_by_user_query<'q>(
    user_ref: &'q str,
    limit: i64,
) -> Query<'q, Postgres, PgArguments> {
    <SqlTrainReservationProjectionRepoContract as TrainReservationProjectionRepoContract>::select_train_reservation_projections_by_user_query(user_ref, limit)
}
